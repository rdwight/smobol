...
# Publish changes to `smobol` to Github (source), and the Python Package
# Index (PyPI).  Latter allows installing with `pip install smobol`.
...
rm -rf build dist smobol.egg-info
